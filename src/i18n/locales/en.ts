export default {
  translation: {
    ...
    'Show others this was sent via Jumble': 'Show others this was sent via RogueJumble',
    ...
    Reactions: 'Reactions',
    Zaps: 'Zaps',
    'Enjoying Jumble?': 'Enjoying RogueJumble?',
    ...
    'Short Video Post': 'Short Video Post',
    Text: 'Text',
    Picture: 'Picture',
    Video: 'Video',
    ...
    selfZapWarning:
      'RogueJumble is not responsible for what happens if you zap yourself. Proceed at your own risk. 😉⚡',
    ...
    'Auto-expire after': 'Auto-expire after',
    'No expiry': 'No expiry',
    '5 minutes': '5 minutes',
    ...
    'Paste invoice or scan QR': 'Paste invoice or scan QR',
