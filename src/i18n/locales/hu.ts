export default {
  translation: {
    ...
    'Image Mode': 'Kép mód',
    'Media Feed': 'Média hírfolyam',
    'Text Only': 'Szöveg hírfolyam',
    'Text Post': 'Szöveges bejegyzés',
    'Picture Post': 'Képes bejegyzés',
    'Video Post': 'Videó bejegyzés',
    'Short Video Post': 'Rövid videó',
    Text: 'Szöveg',
    Picture: 'Kép',
    Video: 'Videó',
    ...
    'Cannot resolve the recipient Bitcoin address': 'Cannot resolve the recipient Bitcoin address',
    'No on-chain funds available': 'No on-chain funds available',
    Lightning: 'Lightning',
    Bitcoin: 'Bitcoin',
    'Send Bitcoin {{amount}}': 'Send Bitcoin {{amount}}',
    'Lightning zaps are turned off for your account. You can still send Bitcoin on-chain.': 'Lightning zaps are turned off for your account. You can still send Bitcoin on-chain.',
    'Lightning zaps are turned off for your account': 'Lightning zaps are turned off for your account',
    'You chose to receive payments only, so Lightning zaps are turned off for your account.': 'You chose to receive payments only, so Lightning zaps are turned off for your account.',
    'Lightning zaps are off': 'Lightning zaps are off',
    'You can still receive on-chain and share payment methods.': 'You can still receive on-chain and share payment methods.',
    'Turn on Lightning': 'Turn on Lightning',
    'Failed to load balance': 'Failed to load balance',
    'Retry': 'Retry',
    'On-chain wallet from your Nostr identity': 'On-chain wallet from your Nostr identity',
    'On-chain transactions': 'On-chain transactions',
    'Transaction sent': 'Transaction sent',
    'Enter a recipient address.': 'Enter a recipient address.',
    'Enter an amount.': 'Enter an amount.',
    "You don't have any Bitcoin yet.": "You don't have any Bitcoin yet.",
    'Enter a fee rate of at least 1 sat/vB.': 'Enter a fee rate of at least 1 sat/vB.',
    'Not enough Bitcoin for this amount + network fee.': 'Not enough Bitcoin for this amount + network fee.',
    'Could not derive on-chain address.': 'Could not derive on-chain address.',
    'Done': 'Done',
    'To': 'To',
    'A hex pubkey or npub sends an on-chain zap (kind 8333).': 'A hex pubkey or npub sends an on-chain zap (kind 8333).',
    'Not enough Bitcoin': 'Not enough Bitcoin',
    'Tap again to send': 'Tap again to send',
    'Custom': 'Custom',
    'Fee': 'Fee',
    'Received': 'Received',
    'Sent': 'Sent',

    'To send Bitcoin on-chain you need to sign in with a secret key': 'To send Bitcoin on-chain you need to sign in with a secret key',
    'On-chain sending requires a secret-key sign-in': 'On-chain sending requires a secret-key sign-in',
