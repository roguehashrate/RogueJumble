...
export const THEME_COLORS = {
  ...
  nord: {
    ...
    colors: {
      ...
      primary: '193 39% 68%',
      primaryHover: '193 39% 76%',
      primaryForeground: '211 30% 18%',
      secondary: '217 25% 50%',
      secondaryForeground: '214 32% 91%',
      muted: '219 16% 28%',
      mutedForeground: '218 23% 71%',
      accent: '41 60% 65%',
      accentForeground: '211 30% 18%',
      destructive: '0 50% 60%',
  ...
  everforest: {
    ...
    colors: {
      ...
      primaryForeground: '200 15% 15%',
      secondary: '145 25% 55%',
      secondaryForeground: '43 25% 72%',
      muted: '200 15% 23%',
      mutedForeground: '43 25% 50%',
      accent: '17 37% 64%',
      accentForeground: '200 15% 15%',
      destructive: '0 35% 55%',
  ...
  kanagawa: {
    ...
    colors: {
      ...
      foreground: '60 30% 74%',
      card: '240 13% 18%',
      cardForeground: '60 30% 74%',
      popover: '240 13% 20%',
      popoverForeground: '60 30% 74%',
      primary: '350 55% 55%',
      primaryHover: '350 55% 65%',
      primaryForeground: '240 13% 14%',
      secondary: '220 40% 60%',
      secondaryForeground: '60 30% 74%',
      muted: '240 13% 22%',
      mutedForeground: '60 25% 55%',
      accent: '30 85% 62%',
      accentForeground: '240 13% 14%',
      destructive: '0 45% 55%',
      destructiveForeground: '60 30% 74%',
      border: '240 13% 28%',
      input: '240 13% 20%',
      ring: '350 55% 55%',
